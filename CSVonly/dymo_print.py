...
The Windows release defaults to real printing. Set DYMO_SIMULATE=1 only when
you intentionally want to test without sending labels to the printer.
"""
...
# Default to real printing for the packaged BO Label Station release.
# Use DYMO_SIMULATE=1 only for dry-run testing.
SIMULATE = os.environ.get("DYMO_SIMULATE", "0") != "0"
...
def service_alive() -> bool:
    ...
    try:
        ...
        return r.status_code == 200 and (text == "true" or text == "1")
